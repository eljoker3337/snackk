...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/eljoker3337/snackk/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/eljoker3337/snackk/main/DRAGON.lua')
...
'chat_id'=>$chat_id,
'text'=>"
مرحباً بك في سورس سناك
",
'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'المبرمج ¹','url'=>"t.me/eljo_ker_m"]],
[['text'=>'المبرمج ²','url'=>"t.me/UU_0p"]],
[['text'=>'قناة السورس','url'=>"t.me/SNACK_772"]],
]
])
]);
}
...
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر المبرمج البوبعام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع كتم المبرمج البوبعام")
return false 
end
...
if text == 'العاب سناك' or text == 'العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اسمي الكيوت سناك🌚💕.')
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سناك')
